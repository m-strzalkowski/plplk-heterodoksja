...
\usepackage{float}
\usepackage{placeins}
\usepackage{pdflscape} % For rotating specific pages
\usepackage{enumitem}
...
\acknowledgements{Serdecznie dziękuję promotorowi za wsparcie i cierpliwość, panu Terence'u Parrowi - autorowi Antlr oraz autorom projektu LLVM, narzędzi, które umożliwiły ten projekt}
...
\begin{document}
	...
	\include{rozdzial_1_wprowadzenie}
	\include{rozdzial_2_wywod_jezyka}
	\include{rozdzial_3_implementacja}
    \include{rozdzial_4_wnioski}
